...
<div style="text-align: center">
  ...
  <figcaption>Figure T: Top level diagram of each part of the FPGA design</figcaption>
</div>
...
<div style="text-align: center">
  ...
  <figcaption>Figure T: FSM for sending data to LCD controller</figcaption>
</div>
...
<div style="text-align: center">
  ...
  <figcaption>Figure T: FSM for controlling which data and control signals are sent to the LCD</figcaption>
</div>
